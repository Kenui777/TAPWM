...
function processarFormulario() {
    ...
    document.getElementById('resultadoMaiorIf').innerText = `Maior (usando if): ${maior1}`;
    document.getElementById('resultadoMaiorMath').innerText = `Maior (usando Math.max): ${maior2}`;
